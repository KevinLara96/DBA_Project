...
CREATE TABLE PROV_SERVICIO_COMPROBANTE(
    ...
    COMPROBANTE                     BLOB            DEFAULT EMPTYBLOB(),
    PROVEDOR_SERVICIO_ID            NUMBER(6, 0)    NOT NULL,
...
CREATE TABLE SEGURIDAD(
    ...
    IDENTIFICACION_PDF       BLOB            DEFAULT EMPTYBLOB(),
    COMPROBANTE_DOMICILIO    BLOB            DEFAULT EMPTYBLOB(),
...
CREATE TABLE SERVICIO_REALIZADO_IMAGEN(
    ...
    SERVICIO_IMAGEN                   BLOB             DEFAULT EMPTYBLOB(),
